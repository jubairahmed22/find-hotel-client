...
const Navbar = () => {
  ...
  return (
    <header className="text-gray-900 body-font shadow-sm bg-white-99">
      <div className="flex flex-row justify-between mx-auto w-[80%] h-20">
        <Link
          to="/"
          className="flex title-font font-medium items-center text-transparent bg-clip-text text-indigo-900 mb-4 md:mb-0"
        >
          <span className="ml-3 text-2xl font-bold font-marcellus text-custom-dark">
            Find Hotel
          </span>
        </Link>
        <nav className="md:ml-auto flex flex-wrap items-center  text justify-center">
          {user?.email ? (
            <>
            ...
            <>
              <Link
                to="/login"
                className="mr-5 font-roboto hover:text-green-600 "
              >
                Home
              </Link>
              <Link
              ...
              <div className="mr-5 hover:text-green-600  font-roboto">
                Tel: +8801675****
              </div>
              <Link
                to="/login"
              ...
              <Link to="/signup" className="mr-5">
                <PrimaryButton classes=" px-7 py-3 font-roboto font-lg ">
                  Signup
                </PrimaryButton>
              </Link>
            </>
