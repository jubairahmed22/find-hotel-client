    ...
    <div className="w-full">
      ...
      <form onSubmit={handleSubmit} className="rounded-lg bg-white ">
        <div className="mt-6 flex flex-row gap-5 bg-white p-5 ">
          <div className="shadow-xl rounded-md my-2 p-3 w-[400px]">
            ...
            <input
              ...
              className="block w-full mt-2 font-jost p-1 text-gray-700 text-center bg-white   focus:border-indigo-800 focus:ring-indigo-800 focus:outline-none focus:ring focus:ring-opacity-40"
            />
          </div>
